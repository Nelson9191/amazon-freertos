...
void analog_handler_task(void * pvParameters){
    ...
    for(;;){
        ...
        if(init){
            if(USE_AN01){
                //printf("AN01: %d\n", adc_reading_an01);
                range = analog_handler_get_range_for_gpio(AN01);
            ...
            if(USE_AN02){
                range = analog_handler_get_range_for_gpio(AN02);
            ...
            if(USE_AN03){
                range = analog_handler_get_range_for_gpio(AN03);
            ...
            if(USE_AN04){
                range = analog_handler_get_range_for_gpio(AN04);
            ...
            if(USE_AN05){
                range = analog_handler_get_range_for_gpio(AN05);
            ...
            if(USE_AN06){
                range = analog_handler_get_range_for_gpio(AN06);
...
static uint32_t analog_handler_get_range_for_gpio(uint32_t gpio){
    switch(gpio){
        case AN01:
            return ANALOG_RANGE_AN01;
            break;
        case AN02:
            return ANALOG_RANGE_AN02;
            break;
        case AN03:
            return ANALOG_RANGE_AN03;
            break;
        case AN04:
            return ANALOG_RANGE_AN04;
            break;
        case AN05:
            return ANALOG_RANGE_AN05;
            break;
        case AN06:
            return ANALOG_RANGE_AN06;
            break;
        default:
            return 50;                                          
    }
